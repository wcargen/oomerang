...
# TEST ITEMS:
item1 = Item.create([{category_id: 12, location_id: 1, status: 'lost', seeker_id: 1, color: 'silver', details: 'I lost an Ames brand pocket watch with a white face at General Assembly, 414 Brannon St., San Francisco'}])
item2 = Item.create([{category_id: 8, location_id: 2, status: 'found', seeker_id: 2, color: 'you confirm', details: 'I found a black digital watch at AT&T Park', secret_info: 'Black Casio digital watch, scratch on bezel.'}])
item3 = Item.create([{category_id: 9, location_id: 4, status: 'lost', seeker_id: 3, color: 'white', details: 'I lost a white iPhone 5 at Civic Center'}])
item4 = Item.create([{category_id: 9, location_id: 3, status: 'found', finder_id: 5, color: 'white', details: 'I found a white iPhone 5 at Civic Center', secret_info: 'Serial # 123456789ABC, iPhone5, Hello Kitty case.'}])
item5 = Item.create([{category_id: 10, location_id: 3, status: 'lost', seeker_id: 4, color: 'white', details: 'Lost my Samsung S3 at The Civic Center.'}])
item6 = Item.create([{category_id: 11, location_id: 5, status: 'found', finder_id: 8, color: 'black & silver', details: 'I found an Acer 9000 government laptop at The Exploratorium, San Francisco.', secret_info: 'Encrypted HDD, Label stating property of the CIA.'}])
item7 = Item.create([{category_id: 12, location_id: 6, status: 'found', finder_id: 7, color: 'silver', details: 'Found: silver pocket-watch at the Levi Strauss company offices. Contact security.', secret_info: 'Ames brand, White face, two hands, silver chain'}])
item8 = Item.create([{category_id: 7, location_id: 7, status: 'found', finder_id: 6, color: 'white', details: 'Found a wrist-watch under the entrance to the Golden Gate Bridge, San Francisco, CA', secret_info: 'Enscryption on back: To Jimmy From The Mob.'}])
